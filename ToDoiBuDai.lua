...
local Window = Fluent:CreateWindow({
    ...
    --táo hub , aniee hub :>
    Title = "To Doi Bu Dai Hub",
    SubTitle = "Oc Cho Gaming",
    TabWidth = 160,
...
local listfastattack = {'địt thường','địt nhanh','địt siêu nhanh'}

    local DropdownDelayAttack = Tabs.Main:AddDropdown("DropdownDelayAttack", {
        Title = "Select địt nhanh",
	...
	if _G.FastAttackFaiFao_Mode == "địt nhanh" then
		_G.Fast_Delay = 0.15
	elseif _G.FastAttackFaiFao_Mode == "địt thường" then
		_G.Fast_Delay = 0.25
	elseif _G.FastAttackFaiFao_Mode == "địt siêu nhanh" then
		_G.Fast_Delay = 0.05
	end
end)
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Auto chim Mastery", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "địt con cặc bột", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "địt Boss", Default = false })
...
if Third_Sea then
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = " địt Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = " địt Piranha", Default = false })
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = " địt cá mập", Default = false })
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "địt elite Hunter", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "địt quái biển", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "tự động lưỡi hái [Fully]", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "đánh nhà bao dủy", Default = false })
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "giết chim bột [Need Spawn]", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "mua màu con chim",Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "mua kiếm thần cặc",Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Setting Farming")
 ...
 local ToggleFastAttack = Tabs.Setting:AddToggle("ToggleFastAttack", {Title = "xuất nhanh", Default = true })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Auto súng", Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Auto trai oc cac", Default = false })
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "cất trái", Default = false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "random phorut", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "tự nhặt trái óc cặc", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "esp trái óc cặc", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "hoa", Default = false })
...
local Chips = {"lồn","Ice","Quake","Light","Dark","Spider","bao dủy","Magma","Buddha","Sand","Phoenix","Dough"}
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "tu dong suc cac", Default = false })
...
local Mastery = Tabs.Raid:AddSection("Law dái")


local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "dái law", Default = false })
